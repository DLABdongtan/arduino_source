...
// Firebase 설정(ESP32-LIGHT-SENSOR 프로젝트의 값으로 설정한다.)
#define FIREBASE_HOST "https://esp32-light-sensor-db00b-default-rtdb.firebaseio.com/"    //"your_firebase_host"  
#define FIREBASE_AUTH "AIzaSyB23nMtYSfFAXQjaotCKIH_4rIRZgwhoSI"    //"your_firebase_auth"  

#define WIFI_SSID "106-101"        //"your_wifi_ssid"
#define WIFI_PASSWORD "tc092312**"    //"your_wifi_password"
